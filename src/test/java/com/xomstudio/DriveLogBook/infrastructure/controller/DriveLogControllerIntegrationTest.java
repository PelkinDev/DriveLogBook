...
public class DriveLogControllerIntegrationTest {
    ...
    public void shouldCreateOneDriveLog() throws Exception {
        ...
        testVehicleDTOA.setId(1L);
        testDriveLogDtoA.setId(null);
        testDriveLogDtoA.setVehicleDto(testVehicleDTOA);
        driveLogService.addNewDriveLog(1L, testDriveLogDtoA);
    ...
    public void createdDriveLogSuccessfullySaved() throws Exception {
        ...
        mockMvc.perform(
                ...
                MockMvcResultMatchers.jsonPath("$.mileageAtStart").isNumber()
        ).andExpect(
                MockMvcResultMatchers.jsonPath("$.distanceDriven").value(24)
        );
    }
    ...
    public void driveLogListReturnsListOfVehicles() throws Exception {
        ...
        mockMvc.perform(
                ...
                MockMvcResultMatchers.jsonPath("$[0].mileageAtStart").isNumber()
        ).andExpect(
                MockMvcResultMatchers.jsonPath("$[0].distanceDriven").value(24)
        );
    }
